let CandidateLearningApp = new Vue({
    el: '#CandidateLearningApp', 
    data: {
        modules: [],
        toggleView: {
            listview: true,
        ...
        sortCategories: [
            {
                ...
                index: 1,
                value: "difficulty",
                label: "<i class='fal fa-fw fa-layer-group mr-2 dd-sort'></i> Difficulty",
                is_active: false
            },{
                parent_id: -1, 
                index: 1,
    ...
    methods: {
        ...
        seedData: function(){
            ...
            for(var i=0; i<cnt; i++){
                ...
                var status = statuses[Math.floor(Math.random() * 3) + 0];
