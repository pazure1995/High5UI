var modalTenantDeleteComponent = Vue.component('tenant-delete-success', {
    data() {
        return {
            title: '',
            closeBtnText: 'close',
    ...
    methods: {
        ...
        submit: function(employee){
            ...
            setTimeout(function(){
                ...
                if(app.isGeneric){
                    app.successMessage.title = app.title+" Deleted!";
                    app.successMessage.subtitle = "<p>The selected "+app.title+" has been deleted</p>";
                    ...
                    app.successMessage.title = "Tenant Deleted!";
                    app.successMessage.subtitle = "<p>The selected tenant has been deleted</p>";
                    app.successMessage.details = [
                        {
                            label: "Tenant",
                            value: app.item.name
                ...
                if(!app.isGeneric){
                    ...
                    let newList = app.parent.list.filter(function (e) {
                        return e.id != app.item.id;
                    });   

                    app.parent.list = newList;
                }

                if(app.flyout.showFlyout){
                    app.flyout.close();
                }
...
<div class="bl-modal-container">
    ...
    v-bind:class="{'bl-modal-card-sm': size.sm,'bl-modal-card-md': size.md,'bl-modal-card-lg': size.lg,'bl-modal-card-full': size.full}">
        ...
        <div v-if="showBody" class="bl-modal-body">
            ...
            <div v-if="!isGeneric" class="text-center">
            ...
            <div v-if="!isGeneric" class="text-center my-4">
                ...
                <button type="button" v-on:click="submit(item)"  class="btn btn-primary">
            ...
            <div v-else class="text-center my-4">
                ...
                <button type="button" v-on:click="submit(item)"  class="btn btn-primary">
                    ...
                    <span v-if="showSuccessMessage">{{title}} Deleted!</span>
                </button>
            </div>
