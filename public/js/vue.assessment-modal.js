var modalSelfAssessment = Vue.component('modal', {
    data() {
        return {
            title: '',
            isMedium: false,
                    ...
                    v-bind:class="{ 'bl-modal-card-lg': isLarge, 'bl-modal-card-md': isMedium}">
                        <div v-if="!formComplete">
                            ...
                            <div class="bl-modal-body"> 
                                ...
                                <div class="form-floating mb-3">
                                    <select id="floatingSelect" class="form-select">
                                        <option selected="selected" value="1way">1 Way Video Interview</option>
                                ...
                                :options="[{id: 1,text: 'NodeJs'},{id: 2,text: 'React'},{id: 3,text: 'VueJs'}]">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="/candidate/assessments/12312312"  class="btn btn-primary">
                                    Start Assessment
                                </a>                              
                            </div> 
                        </div>
