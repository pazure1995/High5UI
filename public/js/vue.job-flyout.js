var jobFlyoutComponent = Vue.component('profile-flyout', {
    data() {
        return {
            showFlyout: false,
            request: {},
        ...
        <div class="view-panel-header">
            ...
            <div class="px-3 mb-3">
                <div class="d-flex align-items-start flex-wrap-reverse">
                    <div class="d-flex">    
                        <div class="ml-3">
                            <h5 class="mr-2 mb-1">Java Developer</h5>
                            <div class="mb-2">
                                <a href="/recruiter/">id: 2345-1</a> / <span class="mr-2">Full Time / Jacksonville FL.</span>
                            </div>
                            <div>
                                <span class="tag tag-coral">Hot</span>
                                <span class="tag tag-red1">5 days left to fill</span>
                            </div>
                        </div>                    
                    </div>
                    <div class="ml-auto d-flex align-items-center">
                        <div>
                            <button type="button" v-on:click="submit()" class="btn btn-sm">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
