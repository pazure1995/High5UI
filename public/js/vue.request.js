var requestApp = new Vue({
    el: '#RequestView',
        data: {
            ...
            pendingCandidateSubmissions: [
                {
                    name: "TalentLyft",
                    avatar: "<img class='avatar avatar-sm' src='https://logo.clearbit.com/talentlyft.com'/>",
                ...
                {
                    name: "Recruiterbox",
                    avatar: "<img class='avatar avatar-sm' src='https://logo.clearbit.com/recruiterbox.com'/>",
                    status: "<span class='tag tag-blue3'>Pending RTR</span>",
                    location: "Jacksonville Fl.",
                    updatedOn: "3 days ago",
                    expiresOn: "3 days left",
                    video1way: false,
                    video2way: false,
                    videomcq: false,
                    resumedoc: false,
                ...
                {
                    name: "Andy Y.",
                    avatar: "<span class='avatar avatar-purple2 avatar-sm'>AY</span>",
                    status: "<span class='tag tag-blue3'>Pending RTR</span>",
                    location: "Orlando Fl.",
                    updatedOn: "5 days ago",
                    expiresOn: "1 day left",
                    video1way: false,
                    video2way: false,
                    videomcq: false,
                    resumedoc: false,
                ...
                {
                    name: "Sally J.",
                    avatar: "<img class='avatar avatar-sm' src='https://randomuser.me/api/portraits/women/2.jpg'/>",
                    status: "<span class='tag tag-blue3'>Pending RTR</span>",
                    location: "Miami Fl.",
                    updatedOn: "1 days ago",
                    expiresOn: "5 days left",
                    video1way: false,
                    video2way: false,
                    videomcq: false,
                    resumedoc: false,
        ...
        computed: {
            getPendingCandidateSubmissionsLength: function () {
                return this.pendingCandidateSubmissions.length;
            },
            ...
            getAllActiveCandidatesLength: function(){
                return this.getPendingCandidateSubmissionsLength + this.getSubmittedCandidatesLength + this.getShortListedCandidatesLength + this.getInterviewedCandidatesLength + this.getHiredCandidatesLength;
            }
        },
        methods: {
            ...
            hasReviewed: function(){
                ...
                var reviewedCnt = 0;
                for(var i =0; i<this.submittedCandidates.length; i++){
                    if(this.submittedCandidates[i].isReviewed === false){
                        reviewedCnt++;
                    }
                }
