var modalSupplierAddComponent = Vue.component('supplieraddmodal', {
    data() {
        return {
            title: '',
            closeBtnText: 'close',
...
<div class="bl-modal-container">
    <div class="bl-modal-card bl-modal-card-lg">
        ...
        <h6 class="bl-modal-title">Add Supplier</h6>
        ...
        <div v-if="showBody" class="bl-modal-body">
            ...
            <div class="container" v-if="!formComplete">
                <div class="row ">
                    <div class="col-lg-12 mb-2 mb-lg-0">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Enter a job title">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">        
                        <div class="form-floating">
                            <input type="email" class="form-control" placeholder="Enter a job title">
                            <label >Email*</label>
                        </div>
                    </div>
                </div> 
            ...
            <div v-else>
                ...
                <p>A request to add a new supplier has been sent to your administrator.  You will be notified when the administrator approves or rejects your request.  The supplier will not be availabe until it's approved</p>
                <div class="mt-5">
                    <button type="button" v-on:click="close"  class="btn btn-secondary btn-sm">All Done</button>
                    <button type="button" v-on:click="resetSupplierForm"  class="btn btn-sm">Add Another Supplier</button>
                </div>
            </div>
        ...
        <div v-if="!formComplete" class="modal-footer">
            ...
            <button type="button" v-on:click="submit"  class="btn btn-primary btn-sm">
                <span v-if="!submittingForm">Add Supplier</span>
